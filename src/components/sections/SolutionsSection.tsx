            ...
            return (
              <AnimatedCard key={service.title} className="service-card p-6 bg-card hover:bg-muted/50 transition-colors">
                <div className="space-y-4">
                  <Icon className="w-10 h-10 text-foreground drop-shadow-[0_0_15px_rgba(255,255,255,0.6)]" />
                  <h3 className="text-xl font-light drop-shadow-[0_0_15px_rgba(255,255,255,0.5)]">{service.title}</h3>
                  <p className="text-muted-foreground text-sm drop-shadow-[0_0_10px_rgba(255,255,255,0.4)]">{service.description}</p>
                  <AnimatedButton 
